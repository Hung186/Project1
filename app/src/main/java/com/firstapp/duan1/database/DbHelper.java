...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO SANPHAM VALUES (1, 'NHẪN BẠC NỮ ĐÍNH KIM CƯƠNG MOISSANITE POWER LILI_563524', 'APJ', 929000, null, 'Sản phẩm được làm từ bạc S925 đính các viên kim cương Moissanite cao cấp bao quanh. Khoác lên mình thiết kế độc đáo đầy tinh tế, mang đến vẻ đẹp kiêu kỳ, cá tính và sự trẻ trung cho cô nàng sở hữu. Đây cũng là món quà ý nghĩa mà phái mạnh có thể dành cho phái đẹp như thể hiện sự nâng niu, trân trọng, và bảo vệ người phụ nữ mình yêu.\n" +
                ...
                "\n', 2), " +
                "(2, 'NHẪN ĐÍNH HÔN VÀNG 18K - LPN1011568.1', 'Lộc Phát', 31800, null, 'Mang vẻ đẹp sang trọng, quý phái của chất liệu vàng kết hợp cùng nét tinh tế và thanh lịch của thiết kế, nhẫn nữ đính đá xanh lục APJ mang đến cho phái nữ vẻ\n" +
                "3.180.000đ', 2), " +
                "(3, 'NHẪN BẠC NAM ĐÍNH KIM CƯƠNG MOISSANITE KANE LILI_833779', 'APJ', 13600, null, 'Sản phẩm làm từ bạc S925 đính kim cương Moissanite 1 carat sở hữu vẻ đẹp vừa quý phái lại vừa hiện đại, cho phép bạn sáng tạo, mix match cùng những món trang sức cũng như trang phục khác nhau, sẽ giúp bạn nổi bật và thu hút mọi ánh nhìn dù bạn xuất hiện ở đâu, dạo phố, cafe, tiệc tùng hay đi làm. Đừng ngạc nhiên khi nhiều ánh mắt hướng về bạn vì sự tinh tế này nhé !!', 2), " +
                "(4, 'NHẪN NAM VÀNG VÀNG 10K ĐÁ TRẮNG – N2.0124-1', 'APJ', 11700, null, ' Nhẫn vàng nam được thiết kế cách điệu cực HOT thay đổi màu đá theo mệnh với thiết kế hình con rồng tượng trưng cho sự đong đầy, cao quý, thiêng liêng và sức mạnh kiên cường luôn bay trên cao - sản phẩm độc quyền bởi Trang Sức TNJ\n" +
                ...
                "(5, 'Đồng hồ MBT', 'MBT', 30000, null, 'Thời đại công nghệ 4.0, đồng hồ và các tiện ích khác hầu hết đều được tích hợp trong một chiếc điện thoại thông minh. Vì vậy, người ta đeo đồng hồ với mục đích chính không phải là để xem giờ mà là để tự tin, để khẳng định mình. Họ trót yêu vẻ đẹp và sức hấp dẫn của những chiếc đồng hồ, hay đồng hồ mang đến cho họ một phong cách, vẻ đẹp và sức hấp dẫn riêng.', 1), " +
                "(6, 'Đồng Hồ Q&Q', 'Q&Q', 50000, null, 'Nhà phân phối độc quyền các thương hiệu đồng hồ, kính mắt, bút ký nổi tiếng thế giới: Epos Swiss, Atlantic Swiss, Diamond D, Philippe Auguste, Jacques Lemans, Citizen, Aries Gold, dây da đồng hồ, dây đồng hồ đeo tay', 1), " +
                "(7, 'ĐỒNG HỒ CASIO MTP', 'CASIO', 20000, null, 'Mẫu Casio MTP-V004L-1B2UDF mặt số đen size 41mm thiết kế đơn giản trẻ trung 3 kim, phối cùng bộ dây da nâu phiên bản da trơn thời trang.', 1), " +
                "(8, 'ĐỒNG HỒ CASIO EFV', 'CASIO', 40000, null, 'Mẫu Casio EFV-570D-7AVUDF nổi bật với kiểu dáng 6 kim kèm tính năng Chronograph đo thời gian vượt trội đặc trưng thuộc dòng Edifice dành cho các tín đồ yêu thích phong cách thể thao nhưng lại khoác trên mình vẻ ngoài lịch lãm.', 1)");
